	   ...
	   {{-- start breadcrumb --}}
        <div class="card page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title">
                    <h2><span class="font-weight-semibold mx-2">APOTECH</span> - Dosis</h2>
                </div>
            </div>
		...
		<div class="card">
	        <div class="card-header">
	        	<a class="btn btn-primary" href="{{URL::to('/dosis/create')}}"><i class="far fa-plus-square mr-2"></i>Tambah dosis baru</a>
	        </div>
	        <div class="card-body">
	...
	<script>
		$(document).ready(function() {
            ...
            $("#table").DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": {'url':"{{ url('dosisAjax') }}",
                        'headers':"{{ csrf_token() }}"},
                "order": ['0', 'desc'],
                "dataSrc": "data",
                "columns": [
                    {data: 'dosis_id', name: 'dosis_id'},
                    {data: 'obat_id', name: 'obat_id'},
                    {data: 'dosis_value', name: 'dosis_value'},
