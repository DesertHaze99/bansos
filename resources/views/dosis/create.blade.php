@extends('layouts.app')
	...
	@section('content')
		...
		<div class="card page-header page-header-light">
		    <div class="page-header-content header-elements-md-inline">
		        <div class="page-title">
		            <h2><span class="font-weight-semibold mx-2">APOTECH</span> - Tambah dosis baru</h2>
		...
		<div class="card">
			...
			<div class="card-body">
				<form action="{{ route('dosis.store') }}" method="post" enctype="multipart/form-data">
					{{ csrf_field() }}
					...
					<div class="form-group">
						<label>Dosis value:</label>
						<input type="text" class="form-control" placeholder="Silahkan masukan value dosis" name="dosisValue">
					</div>
