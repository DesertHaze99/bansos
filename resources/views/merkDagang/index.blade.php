    ...
    @section('content')
        ...
        <div class="card page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title">
                    <h2><span class="font-weight-semibold mx-2">APOTECH</span> - Merk dagang</h2>
                </div>
            </div>
		...
		<div class="card">
	        <div class="card-header">
	        	<a class="btn btn-primary" href="{{URL::to('/merkDagang/create')}}"><i class="far fa-plus-square mr-2"></i>Tambah merk dagang baru</a>
	        </div>
	        <div class="card-body">
	...
	<script>
		$(document).ready(function() {
            ...
            $("#table").DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": {'url':"{{ url('merekDagangAjax') }}",
                        'headers':"{{ csrf_token() }}"},
                "order": ['0', 'desc'],
                "dataSrc": "data",
                "columns": [
                    {data: 'id_merek_dagang', name: 'id_merek_dagang'},
                    {data: 'merek_dagang_name', name: 'merek_dagang_name'},
