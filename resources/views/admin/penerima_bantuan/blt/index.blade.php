...
<div class="card">
	<div class="card-header header-elements-inline">
		<h1><b>Data Penerima Bantuan BLT</b></h1>
	...
	<div class="modal-dialog" style="border-radius: 10px">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="mb-0">Tambahkan Data Penerima Bantuan BLT Baru, Langkah 1/2</h4> <br>
						...
						<div class="col-lg-4">
							...
							<select id="bantuan_id" class="form-control input-sm" name="bantuan_id">
								...
								@foreach ($jenis_bantuan as $row)
									<option value="{{$row->id_bantuan}}" @if($row->bantuan == 'BLT') selected @endif>{{$row->bantuan}}</option>
								@endforeach
							</select>
						</div>
					</div>
...
@section('script')
	...
	<script>
		$(document).ready(function() {
			...
			document.getElementById("blt").classList.add("nav-item-open");
