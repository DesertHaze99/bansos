		...
		<div class="card page-header page-header-light">
		    <div class="page-header-content header-elements-md-inline">
		        <div class="page-title">
		            <h2><span class="font-weight-semibold mx-2">APOTECH</span> - Tambah interaksi baru</h2>
		        </div>
		    </div>
			...
			<div class="card-body">
				<form action="{{ route('interaksi.store') }}" method="post" enctype="multipart/form-data">
					...
					<div class="text-right">
						<a class="btn btn-warning" href="{{ URL::to('/interaksi') }}"><i class="fas fa-long-arrow-alt-left mr-1"></i>Back</a>
